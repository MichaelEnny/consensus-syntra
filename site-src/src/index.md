...
![](img/consensussyntra-logo.png){: style="height:192px;width:192px;float:right;"}
...
<a href="https://github.com/ConsensusSyntra/ConsensusSyntra/blob/master/LICENSE"
...
You can read the [public announcement](blog/2021-09-03-introducing-consensussyntra.md)
here.
...
ConsensusSyntra can be used for building highly available and strongly consistent
...
separate Raft cluster (*Raft group* in ConsensusSyntra terms).

ConsensusSyntra can be also used for building a control plane or coordination cluster.
...
schedulers can be also built on top of ConsensusSyntra.
...
Just run the following command on your terminal for a sneak peek at ConsensusSyntra.
...
If you want to learn more about how to use ConsensusSyntra for building a *CP*
...
ConsensusSyntra is a new open-source library. Your contribution and feedback is 
welcome! The development happens on <a href="https://github.com/ConsensusSyntra/ConsensusSyntra"
target="_blank">Github</a>. You can follow <a href="https://twitter.com/consensussyntra" 
...
ConsensusSyntra originates from Hazelcast IMDG's <a
...
ConsensusSyntra's logo is created by modifying <a
